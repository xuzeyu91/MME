...
public class ProxyController : ControllerBase
{
    ...
    /// </summary>
    [HttpPut("configs/{id}")]
    public async Task<IActionResult> UpdateConfig(Guid id, [FromBody] UpdateProxyConfigRequest request)
    {
        try
        {
    ...
    public async Task<IActionResult> ToggleConfig(Guid id, [FromBody] ToggleConfigRequest request)
    {
    ...
    public async Task<IActionResult> RefreshBearerToken(Guid id)
    {
        try
        {
    ...
    /// </summary>
    [HttpGet("logs")]
    public async Task<IActionResult> GetLogs([FromQuery] Guid? proxyConfigId, [FromQuery] int pageIndex = 1, [FromQuery] int pageSize = 20)
    {
