...
namespace MME.Domain.Common.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddSqlSugar(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            // 设置静态属性用于向后兼容
            DBConnectionOption.StaticDbType = dbConfig.DbType;
            DBConnectionOption.ConnectionStrings = dbConfig.DBConnection;
            ...
            {
                return SqlSugarHelper.CreateSqlScope(dbConfig);
            });
